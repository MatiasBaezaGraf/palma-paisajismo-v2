import { methodSteps, type ImageAsset } from "../../palma-data";
import { ImageFrame } from "./image-frame";
import { BottomBar, Cta, ReturnLink } from "./layout-parts";
import { Reveal } from "./reveal";

export function MethodologyScreen({ heroImage }: { heroImage: ImageAsset }) {
  return (
    <div>
      ...
      <section className="mx-auto max-w-[1440px] px-5 md:px-[52px]">
        {methodSteps.map((step, index) => (
          <Reveal key={step.n} delay={index * 45}>
            <div className="grid gap-7 border-b border-[#e0ddd7] py-9 md:grid-cols-[5fr_7fr] md:gap-20 md:py-14">
              <div>
